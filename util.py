...
def plot_matches(img1, img2, uv1, uv2, show_immediate=True):
    ...
    Args:
        img1: (H, W, 3), source image, uint8, rgb
        img2: (H, W, 3), destination image, uint8, rgb
...
def plot_keypoints(img1, img2, uv1, uv2, Mf12, thresh_feat, show_immediate=True) -> None:
    ...
    Args:
        img1: (H, W, 3), source image, uint8, rgb
        img2: (H, W, 3), destination image, uint8, rgb
        uv1: (n1, 2), keypoints in img1, int
        uv2: (n2, 2), keypoints in img2, int
